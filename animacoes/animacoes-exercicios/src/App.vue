<template>
	<div id="app" class="container-fluid">
		...
		<!-- 'transition' suporta apenas um único elemento -->
		<!-- propriedade 'mode' faz com que: primeiro um elemento sai, para dps o outro entrar -->
		...
		<!-- Transition com GATILHOS JS -->
		<!-- <b-button :variant=" exibir2 ? 'info' : 'warning' " @click="exibir2 = !exibir2">Alternar</b-button> -->
		<!-- Se eu quero de forma "explicita" desativar qualquer
			influência de classe CSS em cima da animação eu posso inserir:
			:css="false" na tag <transition> -->
		<!-- <transition
		...
		<!-- Transições em grupos de elementos: <transition-group>-->
